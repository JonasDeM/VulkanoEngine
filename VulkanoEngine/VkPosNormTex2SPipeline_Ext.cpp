...
unique_ptr_del<VkDescriptorPool> VkPosNormTex2SPipeline_Ext::CreateDescriptorPool(VkDevice device)
{
...
VkDescriptorSet VkPosNormTex2SPipeline_Ext::CreateAndWriteDescriptorSet(VkDevice device, VkDescriptorPool descPool, VkBuffer uniformBuffer, VkImageView texImageView, VkSampler texSampler)
{
